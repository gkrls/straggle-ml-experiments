data = {
  ...
  "20-natural-sync": { # batch-20, no induced straggle events, sync threads
    "0.25": {"tsc":4,  "real":0.262, "rto":0.14, "all": 11764920, "to":[], "gbit":[53.69,55.03,53.84,55.55], "time":[14.89,14.53,14.85,14.40]},
    ...
    "15.0": {"tsc":229,"real":15.007,"rto":7.51, "all": 11764920, "to":[], "gbit":[], "time": []},
  },
}
