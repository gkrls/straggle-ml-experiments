data = {
  ...
  "batch-natural-nosa-nore-async": {
    "0.50": {"tsc":8,  "real":0.524, "rto":0.27,"all":11764920,"to":[2220,3008,1984,2275],"gbit":[61.14,58.79,60.41,60.86],"time":[13.08,13.41,13.24,13.14]},
    
    "1.00": {"tsc":16, "real":1.048, "rto":0.53,"all":11764920,"to":[1876],"gbit":[60.40,60.27,57.47,59.13],"time":[13.24,13.27,13.91,13.52]},
