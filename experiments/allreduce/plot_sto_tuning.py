data = {
  "batch-natural-nosa-nore-sync": { # batch-20, no induced stragglers, sync threads, sa_disabled, re_disabled
    ...
    "4.50": {"tsc":69, "real":4.521, "rto":2.30,"all":11764920,"to":[   0, 192,   0,  64],"gbit":[57.55,55.80,58.01,56.99],"time":[13.90,14.33,13.78,14.03]},
    
    "5.00": {"tsc":77, "real":5.046, "rto":2.55,"all":11764920,"to":[ 128,   0,   0,   0],"gbit":[58.20,58.25,59.23,57.01],"time":[13.74,13.73,13.50,14.03]},
  ...
  "batch-natural-nosa-nore-async": {
    ...
    "4.50": {"tsc":69, "real":4.521, "rto":2.30,"all":11764920,"to":[   0,   0, 384, 320],"gbit":[61.44,61.80,58.77,59.48],"time":[13.02,12.94,13.61,13.44]},
