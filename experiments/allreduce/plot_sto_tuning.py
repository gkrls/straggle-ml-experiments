data = {
  ...
  "straggle-1-sync": {
    "0.25": {"tsc":4, "real":0.262, "rto":0.14, "gbit":[55.71,54.94,55.53], "time":[14.35,14.55,14.40]},
    "0.50": {"tsc":8, "real":0.524, "rto":0.27, "gbit":[57.5,55.99,57.76], "time":[13.91,14.28,13.85]},
  },
}
