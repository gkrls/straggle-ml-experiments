data = {
  "batch-natural-nosa-nore-sync": { # batch-20, no induced stragglers, sync threads, sa_disabled, re_disabled
    ...
    "4.50": {"tsc":69, "real":4.521, "rto":2.30,"all":11764920,"to":[   0, 256,  64,  64],"gbit":[57.55,55.80,58.01,56.99],"time":[13.90,14.33,13.78,14.03]},
    "5.00": {"tsc":77, "real":5.046, "rto":2.55,"all":11764920,"to":[ 384,  64,   0,   0],"gbit":[58.20,58.25,59.23,57.01],"time":[13.74,13.73,13.50,14.03]},
    "5.50": {"tsc":84, "real":5.505, "rto":2.80,"all":11764920,"to":[   0,   0,   0,   0],"gbit":[57.82,56.00,56.39,55.88],"time":[13.83,14.28,14.18,14.31]},
  ...
  "batch-natural-nosa-nore-async": {
    ...
    "5.50": {"tsc":84, "real":5.505, "rto":2.80,"all":11764920,"to":[],"gbit":[],"time":[]},
