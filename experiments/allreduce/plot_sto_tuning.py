data = {
  "straggle-0" : {
    ...
    "1.0": {
      "tsc": 16,
      "real": 1.048,
      "batch-1" :{"ok":[588246,588246,588246],      "to":[0,0,0],       "gbit":[23.25,24.02,24.30],"time":[33.94,33.29,32.91]},
      "batch-20":{"ok":[11762360,11764144,11764536],"to":[2560,776,384],"gbit":[60.26,60.22,59.78],"time":[13.27,13.28,13.38]}
    },
    "1.25": {
      "tsc": 20,
      "real": 1.31,
  ...
  "straggle-1": {
    "0.25": {"tsc" : 4, "real": 0.262, "batch-20": {"gbit":[60.40,60.76,60.69],"time":[13.24,13.16,13.18]} },
    "0.50": {"tsc" : 8, "real": 0.524, "batch-20": {"gbit":[59.12,58.48,58.13],"time":[13.52,13.67,13.76]} },
    "1.0": {
      "batch-20": {"gbit":[55.32],"time":[14.45]}
    },
    "1.25": {
      "batch-20": {"gbit":[57.40,57.63,56.91,57.39],"time":[13.93,13.87,14.05,13.93]}
    }
  },
