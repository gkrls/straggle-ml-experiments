...
# -------- PROFILER SETUP --------
    ...
    # Stop profiler at the end of the epoch
    if prof:
        prof.stop()
...
def main():
    ...
    # Profiler Switch
    parser.add_argument("--torch_profile", action='store_true', help="Enable PyTorch profiler and dump Chrome trace for first few steps")
